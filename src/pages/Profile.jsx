...
export default function Profile() {
  ...
  const fieldClass =
    "w-full border border-gray-200 bg-white/80 backdrop-blur-sm text-black rounded-xl px-4 py-3.5 outline-none focus:ring-2 focus:ring-[#F06742] focus:border-transparent transition-all duration-200 hover:border-[#F06742]/50 dark:bg-gray-600/80 dark:border-gray-500 dark:text-white text-right";
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute -left-20 -top-20 w-60 h-60 sm:w-80 sm:h-80 bg-gradient-to-r from-[#F06742]/10 to-[#FFA34D]/10 rounded-full blur-3xl animate-pulse"></div>
        <div className="absolute -right-20 -bottom-20 w-60 h-60 sm:w-80 sm:h-80 bg-gradient-to-r from-[#FFA34D]/10 to-[#F06742]/10 rounded-full blur-3xl animate-pulse"></div>
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-72 h-72 sm:w-96 sm:h-96 bg-gradient-to-r from-[#F06742]/5 to-[#FFA34D]/5 rounded-full blur-3xl"></div>
      </div>
      ...
      <motion.button
        ...
        onClick={() => navigate(-1)}
        className="fixed top-4 left-4 z-50 bg-white/80 backdrop-blur-md hover:bg-[#F06742] hover:text-white rounded-full p-2 sm:p-3 text-[#F06742] border border-[#F06742]/30 shadow-lg transition-all duration-300 hover:scale-110 hover:shadow-xl group dark:bg-gray-800/80 dark:text-gray-200 dark:hover:bg-[#F06742]"
      >
        <FaArrowLeft
          size={16}
      ...
      >
        {/* Header Background */}
        <div className="relative h-24 sm:h-32 bg-gradient-to-r from-[#F06742] to-[#FFA34D] overflow-hidden">
          ...
          <div className="flex flex-col items-center text-center lg:flex-row lg:items-end lg:text-right gap-4 sm:gap-6 mb-6 sm:mb-8">
            ...
            >
              {user.avatar ? (
                ...
                <div className="w-20 h-20 sm:w-28 sm:h-28 lg:w-32 lg:h-32 rounded-full bg-gradient-to-r from-[#F06742] to-[#FFA34D] text-white flex items-center justify-center text-2xl sm:text-3xl lg:text-4xl font-bold border-4 border-white shadow-2xl dark:border-gray-800">
                  {user.firstName?.charAt(0).toUpperCase() || "م"}
                </div>
              )}

              {isEditingProfile && activeTab === "profile" && (
                <label className="absolute bottom-1 left-1 sm:bottom-2 sm:left-2 bg-[#F06742] hover:bg-[#FFA34D] text-white p-2 sm:p-3 rounded-full shadow-2xl cursor-pointer transition-all duration-300 hover:scale-110 group-hover:scale-110">
                  <input
                    type="file"
                    className="hidden"
            ...
            <div className="flex-1">
              ...
              >
                ...
                <FaEnvelope className="text-[#F06742] flex-shrink-0" />
              </motion.p>
            </div>
            ...
            >
              {activeTab === "profile" && !isEditingProfile ? (
                <motion.button
                  ...
                  className="flex items-center gap-2 bg-gradient-to-r from-[#F06742] to-[#FFA34D] text-white px-4 py-2 sm:px-6 sm:py-3 rounded-xl font-semibold shadow-lg hover:shadow-xl hover:shadow-[#F06742]/25 transition-all duration-300 text-sm sm:text-base"
                >
                ...
                activeTab === "profile" && (
                  <motion.button
                    ...
                    className={`flex items-center gap-2 px-4 py-2 sm:px-6 sm:py-3 rounded-xl font-semibold shadow-lg transition-all duration-300 text-sm sm:text-base ${
                      hasChanges
                        ? "bg-gradient-to-r from-[#F06742] to-[#FFA34D] text-white hover:shadow-xl hover:shadow-[#F06742]/25"
              ...
              <div className="flex items-center gap-3">
                {tabs.find((tab) => tab.id === activeTab)?.icon &&
                  React.createElement(
                    tabs.find((tab) => tab.id === activeTab).icon,
                    {
                      className: "text-[#F06742] text-xl",
                    },
                  )}
                <span>{tabs.find((tab) => tab.id === activeTab)?.label}</span>
              </div>
              <FaBars className="text-[#F06742]" />
            </motion.button>
                  ...
                  {tabs.map((tab) => (
                    <motion.button
                      ...
                      className={`w-full flex items-center gap-3 p-4 text-right transition-all duration-200 ${
                        activeTab === tab.id
                          ? "bg-gradient-to-r from-[#fff8e7] to-[#ffe5b4] text-[#F06742] dark:from-gray-600 dark:to-gray-500"
            ...
            {tabs.map((tab) => (
              <motion.button
                ...
                className={`flex items-center gap-3 flex-1 py-4 px-6 rounded-xl font-semibold transition-all duration-300 text-right ${
                  activeTab === tab.id
                    ? "bg-white text-[#F06742] shadow-lg dark:bg-gray-600 dark:text-[#F06742]"
                    : "text-gray-600 hover:text-[#F06742] hover:bg-white/50 dark:text-gray-300 dark:hover:bg-gray-600/50"
                }`}
              >
                <tab.icon className="text-xl flex-shrink-0" />
                <div className="flex-1">
                  ...
                  <div
                    className={`text-sm mt-1 ${
                      activeTab === tab.id
                        ? "text-[#F06742]/80 dark:text-[#F06742]/70"
                        : "text-gray-500 dark:text-gray-400"
                    }`}
                  >
                    {tab.description}
                  ...
                  <div className="space-y-3 sm:space-y-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="relative group">
                        <FaUser
                          className={`absolute right-3 sm:right-4 top-1/2 transform -translate-y-1/2 text-[#F06742] text-lg transition-all duration-300 group-focus-within:scale-110 ${
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="relative group">
                        <FaEnvelope className="absolute right-3 sm:right-4 top-1/2 transform -translate-y-1/2 text-[#F06742] text-lg transition-all duration-300 opacity-70" />
                ...
                <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-4 sm:p-6 border border-gray-200/50 shadow-lg dark:bg-gray-700/80 dark:border-gray-600/50">
                  ...
                  <div className="space-y-3 sm:space-y-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="relative group">
                        <FaLock className="absolute right-3 sm:right-4 top-1/2 transform -translate-y-1/2 text-[#F06742] text-lg transition-all duration-300 group-focus-within:scale-110 opacity-70" />
                        <input
                        ...
                        <div
                          ...
                          className="absolute left-3 sm:left-4 top-1/2 transform -translate-y-1/2 text-gray-500 hover:text-[#F06742] cursor-pointer transition-all duration-200 hover:scale-110 dark:text-gray-400"
                        >
                    ...
                    <div className="bg-gradient-to-r from-[#fff8e7] to-[#ffe5b4] p-3 sm:p-4 rounded-xl border border-[#FFA34D]/30 space-y-2 dark:from-gray-600 dark:to-gray-500 dark:border-gray-500">
                      <p className="text-sm font-semibold text-[#F06742] mb-2 text-right">
                        متطلبات كلمة المرور:
                      </p>
