        ...
        <div className="p-8">
          {loading ? (
            ...
            >
              ...
              {/* Animated Dots */}
              <div className="flex space-x-2 justify-center mt-4">
                <div className="w-2 h-2 bg-[#F06742] rounded-full animate-bounce"></div>
                <div
                  className="w-2 h-2 bg-[#FFA34D] rounded-full animate-bounce"
                  style={{ animationDelay: "0.2s" }}
                ></div>
                <div
                  className="w-2 h-2 bg-[#F06742] rounded-full animate-bounce"
                  style={{ animationDelay: "0.4s" }}
                ></div>
              </div>
            </motion.div>
