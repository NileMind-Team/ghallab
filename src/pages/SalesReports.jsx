...
<title>تقرير المبيعات - Ghallab</title>
<style>
  @media print {
          ...
          >
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-4">
              <div className="flex items-center gap-2">
                <FaCalendarAlt className="text-[#F06742] text-xl" />
                    ...
                    <button
                      ...
                      className={`w-full flex items-center justify-between px-3 py-2.5 border ${
                        isBranchDropdownOpen
                          ? "border-[#F06742] ring-2 ring-[#F06742]/30"
                          : "border-gray-300 dark:border-gray-600"
                      } dark:bg-gray-700 dark:text-white rounded-lg focus:ring-2 focus:ring-[#F06742] focus:border-transparent outline-none text-right group transition-all`}
                    >
                      <div className="flex items-center gap-2">
                      ...
                      <FaChevronDown
                        className={`text-[#F06742] transition-transform duration-300 ${
