...
const ProductDetails = () => {
  ...
  const formatPriceDisplay = (product) => {
    if (product.isPriceBasedOnRequest) {
      return (
        <div className="text-[#F06742] font-bold text-2xl md:text-3xl">
          السعر حسب الطلب
        </div>
      );
    }
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-white via-[#fff8e7] to-[#ffe5b4] dark:from-gray-900 dark:via-gray-800 dark:to-gray-700 px-4">
        <div className="text-center">
          ...
          <button
            onClick={() => navigate("/")}
            className="bg-gradient-to-r from-[#F06742] to-[#FFA34D] text-white px-6 py-3 rounded-xl font-semibold hover:shadow-lg transition-all"
          >
            العودة للرئيسية
          </button>
        </div>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-white via-[#fff8e7] to-[#ffe5b4] dark:from-gray-900 dark:via-gray-800 dark:to-gray-700 transition-colors duration-300">
      ...
      <motion.div
        initial={{ scale: 0 }}
        animate={{ scale: 1 }}
        className={`fixed bottom-4 right-4 sm:bottom-6 sm:right-6 bg-gradient-to-r from-[#F06742] to-[#FFA34D] text-white rounded-full p-3 sm:p-4 shadow-2xl z-40 cursor-pointer hover:scale-110 transition-transform duration-200 ${
          ...
          >
            <div className="bg-white dark:bg-gray-800 rounded-2xl md:rounded-3xl shadow-xl md:shadow-2xl overflow-hidden">
              ...
              {product.itemOffer && product.itemOffer.isEnabled && (
                ...
                >
                  <div className="bg-gradient-to-r from-[#F06742] to-[#FF8C42] text-white px-3 py-1.5 md:px-4 md:py-2 rounded-xl shadow-2xl flex items-center gap-1.5 md:gap-2">
          ...
          >
                                ...
                                <div key={option.id} className="relative">
                                  ...
                                  >
                                    <div className="flex items-center gap-1 md:gap-2">
                                      ...
                                      {isSelected && (
                                        <FaCheck className="text-[#F06742] text-xs md:text-sm" />
                                      )}
                                    </div>
            ...
            >
              ...
              >
                ...
                <div className="text-xl md:text-2xl font-bold text-[#F06742] whitespace-nowrap text-center sm:text-right order-1 sm:order-2">
