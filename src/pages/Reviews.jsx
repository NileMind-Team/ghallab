  ...
  return (
    ...
    >
      ...
      <motion.button
        ...
        onClick={() => navigate(-1)}
        className="fixed top-3 sm:top-4 left-3 sm:left-4 z-50 bg-white/80 backdrop-blur-md hover:bg-[#F06742] hover:text-white rounded-full p-2 sm:p-3 text-[#F06742] border border-[#F06742]/30 shadow-lg transition-all duration-300 hover:scale-110 hover:shadow-xl group dark:bg-gray-800/80 dark:text-gray-200 dark:hover:bg-[#F06742]"
      >
        <FaArrowLeft
          size={14}
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3 sm:gap-4">
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2 sm:gap-3 mb-2 sm:mb-3">
                          <div className="p-1 sm:p-2 rounded-lg sm:rounded-xl bg-gradient-to-r from-[#fff8e7] to-[#ffe5b4] border border-[#FFA34D]/30 dark:from-gray-600 dark:to-gray-500">
                            <FaStore className="text-[#F06742] text-xs sm:text-sm" />
                          </div>
                ...
                >
                  <div className="bg-white/80 backdrop-blur-sm rounded-xl sm:rounded-2xl p-3 sm:p-4 md:p-5 lg:p-6 border border-gray-200/50 shadow-lg sticky top-4 sm:top-6 dark:bg-gray-700/80 dark:border-gray-600/50">
                    <div className="flex items-center justify-between mb-3 sm:mb-4">
                      ...
                      <button
                        onClick={resetForm}
                        className="text-gray-500 hover:text-[#F06742] transition-colors duration-200 flex-shrink-0 ml-2 dark:text-gray-400"
                      >
                    ...
                    >
                      ...
                      <div>
                        ...
                        <div className="relative">
                          <button
                            ...
                            className="w-full flex items-center justify-between border border-gray-200 bg-white rounded-lg sm:rounded-xl px-3 py-2.5 sm:py-3 text-gray-600 hover:border-[#F06742] transition-all group text-sm sm:text-base dark:bg-gray-600 dark:border-gray-500 dark:text-gray-300"
                          >
                            <div className="flex items-center gap-3">
                              <FaStore className="text-[#F06742] text-sm" />
                              <span>
                                {formData.branchId
                                  ? branches.find(
                                      (b) =>
                      ...
                      <div>
                        ...
                        <div className="flex items-center justify-between gap-2 bg-gradient-to-r from-[#fff8e7] to-[#ffe5b4] p-2 sm:p-3 rounded-lg sm:rounded-xl border border-[#FFA34D]/30 dark:from-gray-600 dark:to-gray-500 dark:border-gray-500">
                          <div className="flex items-center gap-2 flex-shrink-0">
                            <FaStar className="text-[#F06742] text-xs sm:text-sm" />
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <span className="text-xs sm:text-sm font-semibold text-[#F06742] whitespace-nowrap">
                              ({formData.rating}/5)
                            </span>
                          </div>
                        </div>
                      ...
                      <div>
                        ...
                        <textarea
                          ...
                          required
                          rows="4"
                          className="w-full border border-gray-200 bg-white text-black rounded-lg sm:rounded-xl px-3 py-2.5 sm:py-3 outline-none focus:ring-2 focus:ring-[#F06742] focus:border-transparent transition-all duration-200 text-sm sm:text-base resize-none dark:bg-gray-600 dark:border-gray-500 dark:text-white"
                      ...
                      <div className="flex gap-2 sm:gap-3 pt-1 sm:pt-2">
                        <motion.button
                          ...
                          whileTap={{ scale: 0.98 }}
                          onClick={resetForm}
                          className="flex-1 py-2.5 sm:py-3 border-2 border-[#F06742] text-[#F06742] rounded-lg sm:rounded-xl font-semibold hover:bg-[#F06742] hover:text-white transition-all duration-300 text-sm sm:text-base dark:border-[#F06742] dark:text-[#F06742] dark:hover:bg-[#F06742] dark:hover:text-white"
                        >
                          إلغاء
                        </motion.button>
                        <motion.button
