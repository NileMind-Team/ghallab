        ...
        >
          <div className="flex items-center gap-3 sm:gap-4">
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              onClick={() => navigate(-1)}
              className="bg-white/80 backdrop-blur-md rounded-full p-2 sm:p-3 text-[#F06742] hover:bg-[#F06742] hover:text-white transition-all duration-300 shadow-lg dark:bg-gray-800/80 dark:text-gray-200 dark:hover:bg-[#F06742]"
            >
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <div className="flex-1 relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-3 border border-gray-200 rounded-xl bg-white text-black focus:ring-2 focus:ring-[#F06742] focus:border-transparent transition-all duration-200 text-sm sm:text-base dark:bg-gray-700 dark:border-gray-600 dark:text-white"
              />
            </div>
            ...
            <div className="flex gap-2 w-full sm:w-auto">
              <motion.button
                ...
                className="flex items-center gap-2 bg-gradient-to-r from-[#F06742] to-[#FFA34D] text-white px-4 sm:px-5 py-3 rounded-xl font-semibold shadow-lg hover:shadow-xl transition-all duration-300 text-sm sm:text-base whitespace-nowrap w-full sm:w-auto justify-center"
              >
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3 sm:gap-4">
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2 sm:gap-3 mb-4 sm:mb-5">
                        <div className="p-3 sm:p-4 bg-gradient-to-r from-[#fff8e7] to-[#ffe5b4] dark:from-gray-700 dark:to-gray-600 rounded-xl sm:rounded-2xl border border-[#FFA34D]/30 dark:border-gray-500">
                          {offer.isPercentage ? (
                            <FaPercent className="text-[#F06742] dark:text-[#FFA34D] text-xl sm:text-2xl" />
                          ) : (
                            <FaMoneyBillWave className="text-[#F06742] dark:text-[#FFA34D] text-xl sm:text-2xl" />
                          )}
                        </div>
                              ...
                              <div>
                                ...
                                <p className="font-bold text-blue-600 dark:text-blue-400 text-2xl">
                                  {offer.menuItem?.basePrice === 0 ? (
                                    <span className="text-[#F06742] dark:text-[#FFA34D] font-bold">
                                      السعر حسب الطلب
                                    </span>
                                  ) : (
                                    `ج.م ${
            ...
            {!loading && filteredOffers.length === 0 && (
              ...
              >
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  onClick={handleAddNewOffer}
                  className="flex items-center gap-2 bg-gradient-to-r from-[#F06742] to-[#FFA34D] text-white px-4 sm:px-6 py-2.5 sm:py-3 rounded-lg sm:rounded-xl font-semibold shadow-lg hover:shadow-xl transition-all duration-300 text-sm sm:text-base mx-auto"
                >
              ...
              >
                <div className="bg-white/90 backdrop-blur-xl rounded-2xl sm:rounded-3xl shadow-xl sm:shadow-2xl p-4 sm:p-5 lg:p-6 border border-gray-200/50 dark:bg-gray-800/90 dark:border-gray-600 sticky top-4 sm:top-6 transition-colors duration-300">
                  <div className="flex items-center justify-between mb-3 sm:mb-4">
                    ...
                    <button
                      onClick={resetForm}
                      className="text-gray-500 hover:text-[#F06742] dark:text-gray-400 dark:hover:text-[#FFA34D] transition-colors duration-200 flex-shrink-0 ml-2"
                    >
                  ...
                  >
                    <div>
                      ...
                      <div className="relative">
                        <button
                          ...
                          className="w-full flex items-center justify-between border border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-700 text-black dark:text-white rounded-lg sm:rounded-xl px-3 py-2.5 sm:py-3 outline-none focus:ring-2 focus:ring-[#F06742] focus:border-transparent transition-all duration-200 text-sm sm:text-base disabled:opacity-50 disabled:cursor-not-allowed text-right"
                        >
                          <span className="flex items-center gap-2 truncate">
                            <FaHamburger className="text-[#F06742] flex-shrink-0" />
                            {formData.menuItemId
                              ? (() => {
                          ...
                          >
                            {loadingItems ? (
                              <FaSpinner className="text-[#F06742] animate-spin" />
                            ) : (
                            ...
                            >
                              {loadingItems ? (
                                <div className="flex items-center justify-center py-4">
                                  <FaSpinner className="text-[#F06742] animate-spin text-lg" />
                      ...
                      <div>
                        ...
                        <div className="relative group">
                          {formData.isPercentage ? (
                            <FaPercent className="absolute right-3 top-1/2 transform -translate-y-1/2 text-[#F06742] text-sm" />
                          ) : (
                            <FaMoneyBillWave className="absolute right-3 top-1/2 transform -translate-y-1/2 text-[#F06742] text-sm" />
                          )}
                          <input
                            type="number"
                            name="discountValue"
                            ...
                            className="w-full border border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-700 text-black dark:text-white rounded-lg sm:rounded-xl pl-3 pr-9 py-2.5 sm:py-3 outline-none focus:ring-2 focus:ring-[#F06742] focus:border-transparent transition-all duration-200 text-sm sm:text-base text-right"
                            placeholder={
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                      <div>
                        ...
                        <div className="relative group">
                          <FaCalendarAlt className="absolute right-3 top-1/2 transform -translate-y-1/2 text-[#F06742] text-sm" />
                          <input
                            type="date"
                            name="startDate"
                            ...
                            onChange={handleInputChange}
                            required
                            className="w-full border border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-700 text-black dark:text-white rounded-lg sm:rounded-xl pl-3 pr-9 py-2.5 sm:py-3 outline-none focus:ring-2 focus:ring-[#F06742] focus:border-transparent transition-all duration-200 text-sm sm:text-base"
                          />
                        </div>
                      </div>
                      <div>
                        ...
                        <div className="relative group">
                          <FaClock className="absolute right-3 top-1/2 transform -translate-y-1/2 text-[#F06742] text-sm" />
                          <input
                            type="time"
                            name="startTime"
                            ...
                            {branches.map((branch) => (
                              ...
                              >
                                <input
                                  ...
                                  className="text-[#F06742] focus:ring-[#F06742] rounded"
                                />
                    ...
                    <div className="flex items-center gap-3 p-3 bg-gradient-to-r from-[#fff8e7] to-[#ffe5b4] dark:from-gray-700 dark:to-gray-600 rounded-xl border border-[#FFA34D]/30 dark:border-gray-500">
                      <input
                        type="checkbox"
                        name="isEnabled"
                        checked={formData.isEnabled}
                        onChange={handleInputChange}
                        className="w-4 h-4 text-[#F06742] bg-gray-100 border-gray-300 rounded focus:ring-[#F06742] focus:ring-2"
                      />
                    ...
                    <div className="flex gap-2 sm:gap-3 pt-1 sm:pt-2 flex-col sm:flex-row">
                      <motion.button
                        ...
                        whileTap={{ scale: 0.98 }}
                        onClick={resetForm}
                        className="flex-1 py-2.5 sm:py-3 border-2 border-[#F06742] text-[#F06742] rounded-lg sm:rounded-xl font-semibold hover:bg-[#F06742] hover:text-white transition-all duration-300 text-sm sm:text-base"
                      >
                        إلغاء
                      </motion.button>
                      <motion.button
