        ...
        <div className="p-8">
          {!loading && message ? (
            <div className="flex flex-col items-center justify-center py-8 space-y-6">
              ...
              <h2 className="text-2xl font-bold bg-gradient-to-r from-[#F06742] to-[#FFA34D] bg-clip-text text-transparent text-center">
                {success
                  ? "تم إعادة تعيين كلمة المرور بنجاح"
                  : "فشل إعادة التعيين"}
              </h2>
              ...
              {success && (
                <motion.button
                  ...
                  className="mt-4 bg-gradient-to-r from-[#F06742] to-[#FFA34D] text-white px-8 py-3 rounded-xl font-semibold hover:shadow-xl hover:shadow-[#F06742]/25 transition-all duration-300"
                >
            ...
            <>
              <div className="text-center mb-8">
                <h2 className="text-3xl font-bold bg-gradient-to-r from-[#F06742] to-[#FFA34D] bg-clip-text text-transparent">
              ...
              <form onSubmit={handleResetPassword} className="space-y-6">
                <div className="relative group">
                  <div className="absolute inset-y-0 left-0 flex items-center justify-center pl-4">
                    <FaLock className="text-[#F06742] text-lg transition-all duration-300 group-focus-within:scale-110" />
                  </div>
                  <input
                    ...
                    className="w-full border border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-800 text-black dark:text-white rounded-xl pl-12 pr-12 py-4 outline-none focus:ring-2 focus:ring-[#F06742] focus:border-transparent transition-all duration-200 group-hover:border-[#F06742]/50"
                  />
                  <div className="absolute inset-y-0 right-0 flex items-center justify-center pr-4">
                    <div
                      onClick={() => setShowPassword(!showPassword)}
                      className="text-gray-500 dark:text-gray-400 hover:text-[#F06742] cursor-pointer transition-all duration-200 hover:scale-110"
                    >
                      {showPassword ? (
                        <FaEyeSlash size={18} />
                      ) : (
                ...
                <div className="bg-gradient-to-r from-[#fff8e7] to-[#ffe5b4] dark:from-gray-800 dark:to-gray-700 p-4 rounded-xl border border-[#FFA34D]/30 dark:border-gray-600 space-y-2 transition-colors duration-300">
                  <p className="text-sm font-semibold text-[#F06742]">
                    متطلبات كلمة المرور:
                  </p>
              ...
              <div className="flex space-x-2 justify-center mt-8">
                <div className="w-3 h-3 bg-[#F06742] rounded-full animate-bounce"></div>
                <div
                  className="w-3 h-3 bg-[#FFA34D] rounded-full animate-bounce"
                  style={{ animationDelay: "0.2s" }}
                ></div>
                <div
                  className="w-3 h-3 bg-[#F06742] rounded-full animate-bounce"
