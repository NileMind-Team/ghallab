...
const Home = () => {
  ...
  const formatPriceDisplay = (product) => {
    if (product.isPriceBasedOnRequest) {
      return (
        <div className="text-[#F06742] font-bold text-lg sm:text-xl">
          السعر حسب الطلب
        </div>
      );
    }
  ...
  const formatPriceDisplayMobile = (product) => {
    if (product.isPriceBasedOnRequest) {
      return (
        <div className="text-[#F06742] font-bold text-sm">السعر حسب الطلب</div>
      );
    }
    ...
    if (product.itemOffer && product.itemOffer.isEnabled) {
      return (
        <>
          ...
          <div className="text-[#F06742] font-bold text-sm">
            {product.finalPrice.toFixed(2)} ج.م
          </div>
        </>
      );
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-white via-[#fff8e7] to-[#ffe5b4] dark:from-gray-900 dark:via-gray-800 dark:to-gray-700 font-sans relative overflow-x-hidden">
      ...
      >
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl p-3 md:p-4 relative w-full">
          <button
            ...
            className="absolute left-1 md:left-2 top-1/2 transform -translate-y-1/2 bg-white/90 dark:bg-gray-700/90 backdrop-blur-sm rounded-full p-2 text-gray-600 dark:text-gray-300 hover:text-[#F06742] z-10 shadow-lg"
          >
              ...
              <button
                ...
                className={`flex-shrink-0 flex items-center gap-2 px-3 md:px-4 py-2 md:py-3 rounded-xl font-semibold text-sm md:text-base ${
                  selectedCategory === category.id
                    ? "bg-gradient-to-r from-[#F06742] to-[#FFA34D] text-white shadow-lg"
          ...
          <button
            ...
            className="absolute right-1 md:right-2 top-1/2 transform -translate-y-1/2 bg-white/90 dark:bg-gray-700/90 backdrop-blur-sm rounded-full p-2 text-gray-600 dark:text-gray-300 hover:text-[#F06742] z-10 shadow-lg"
          >
          ...
          <div className="max-w-7xl mx-auto px-2 sm:px-4 py-4 md:py-6 w-full">
            <div className="text-center py-12 md:py-16 bg-white dark:bg-gray-800 rounded-2xl shadow-lg mx-2">
              ...
              <button
                ...
                className="bg-gradient-to-r from-[#F06742] to-[#FFA34D] text-white px-6 py-3 rounded-xl font-semibold shadow-lg text-sm md:text-base"
              >
                عرض جميع المنتجات
              </button>
            </div>
                ...
                >
                  {product.itemOffer && product.itemOffer.isEnabled && (
                    <div className="absolute top-2 right-2 z-10">
                      <div className="bg-gradient-to-r from-[#F06742] to-[#FF8C42] text-white px-3 py-1.5 rounded-xl shadow-2xl flex items-center gap-1.5">
                  ...
                  <div className="sm:hidden">
                    <div className="p-3">
                      <div className="flex">
                        ...
                        <div className="flex-1 min-w-0">
                          <h3
                            className="font-bold text-sm text-gray-800 dark:text-gray-200 hover:text-[#F06742] line-clamp-1 mb-2"
                        ...
                        <button
                          ...
                          className={`flex-1 py-2.5 rounded-xl font-semibold flex items-center justify-center gap-2 text-xs no-product-details ${
                            addingToCart === product.id
                              ...
                              : isProductAvailableForCart(product)
                                ? "bg-gradient-to-r from-[#F06742] to-[#FFA34D] text-white"
                  ...
                  <div className="hidden sm:block">
                    ...
                    <div className="p-3 sm:p-4">
                      <h3
                        className="font-bold text-base sm:text-lg text-gray-800 dark:text-gray-200 mb-2 hover:text-[#F06742] line-clamp-1"
                        dir={isArabic(product.name) ? "rtl" : "ltr"}
                      >
                        {product.name}
                      </h3>
      ...
      {/* Cart Button */}
      <div
        className={`fixed bottom-4 right-4 sm:bottom-6 sm:right-6 bg-gradient-to-r from-[#F06742] to-[#FFA34D] text-white rounded-full p-3 sm:p-4 shadow-2xl z-40 cursor-pointer hover:scale-110 no-product-details ${
      ...
      >
        <div className="relative">
          ...
          {cartItemsCount > 0 && (
            <span className="absolute -top-2 -right-2 bg-white text-[#F06742] rounded-full w-4 h-4 sm:w-5 sm:h-5 flex items-center justify-center text-xs font-bold">
              {cartItemsCount}
            </span>
          )}
        </div>
      ...
      <div className="fixed bottom-4 left-4 flex flex-col gap-3 z-40">
        ...
        <button
          ...
          className="relative bg-gradient-to-r from-[#FF6B8B] to-[#FF9E7D] text-white rounded-full p-3 sm:p-4 shadow-2xl hover:scale-110 no-product-details"
        >
          <div className="relative flex items-center justify-center">
            <FaHeart className="w-4 h-4 sm:w-6 sm:h-6" />

            {favorites.length > 0 && (
              <span className="absolute -top-2 -right-2 bg-white text-[#FF6B8B] rounded-full w-4 h-4 sm:w-5 sm:h-5 flex items-center justify-center text-xs font-bold shadow-md">
                {favorites.length}
              </span>
            )}
          </div>
                    ...
                    <div className="lg:col-span-2">
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          className="w-full pl-10 sm:pl-12 pr-3 sm:pr-4 py-3 sm:py-4 rounded-xl border-2 border-gray-200 dark:border-gray-600 dark:bg-gray-600 dark:text-white focus:ring-2 focus:ring-[#F06742] focus:border-[#F06742] outline-none text-right text-base font-medium"
                        />
                      </div>
                    </div>
                      ...
                      <div
                        ...
                        className={`bg-white dark:bg-gray-700 border-2 ${
                          category.id === "all" || category.id === "offers"
                            ...
                            : "border-gray-200 dark:border-gray-600 hover:border-[#F06742]/30 dark:hover:border-[#F06742]/30"
                          ...
                          <div className="space-y-4 sm:space-y-6">
                            <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6">
                              <div className="lg:col-span-2">
                                ...
                                <input
                                  ...
                                  className="w-full px-3 sm:px-4 py-3 sm:py-4 rounded-xl border-2 border-gray-200 dark:border-gray-600 dark:bg-gray-600 dark:text-white focus:ring-2 focus:ring-[#F06742] focus:border-[#F06742] outline-none text-right text-base font-medium"
                                  dir="rtl"
                                />
                              </div>
                            ...
                            <div className="flex gap-2 sm:gap-3 justify-start pt-3 sm:pt-4 border-t border-gray-200 dark:border-gray-600">
                              ...
                              <button
                                ...
                                className="bg-gradient-to-r from-[#F06742] to-[#FFA34D] text-white px-4 sm:px-6 py-2 sm:py-3 rounded-xl font-bold shadow-lg flex items-center gap-2 text-sm sm:text-base no-product-details"
                              >
                                <FaSave />
                                حفظ التغييرات
                              </button>
