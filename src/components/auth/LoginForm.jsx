    ...
    >
      <div className="text-center mb-2">
        ...
        <p className="text-gray-600 dark:text-gray-400 mt-2 text-sm">
          سجل الدخول إلى حسابك في Ghallab
        </p>
      </div>
      ...
      <div className="flex justify-between items-center">
        <button
          ...
          className="text-[#F06742] dark:text-[#FFA34D] hover:text-[#FFA34D] dark:hover:text-[#F06742] underline text-sm font-medium transition-all duration-200"
        >
          نسيت كلمة المرور؟
        </button>
      </div>
