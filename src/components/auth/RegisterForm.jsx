  ...
  return (
    ...
    >
      ...
      <div className="space-y-4">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          <div className="relative group">
            <div className="absolute inset-y-0 right-0 flex items-center justify-center pr-3">
              <FaUser className="text-[#F06742] dark:text-[#FFA34D] text-lg transition-all duration-300 group-focus-within:scale-110" />
            </div>
            <input
              type="text"
              name="firstName"
              ...
              className="w-full border border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-800 text-black dark:text-white rounded-xl pr-10 pl-3 py-3.5 outline-none focus:ring-2 focus:ring-[#F06742] dark:focus:ring-[#FFA34D] focus:border-transparent transition-all duration-200 group-hover:border-[#F06742]/50 dark:group-hover:border-[#FFA34D]/50 text-sm text-right"
            />
          </div>
        ...
        <div className="relative group">
          <div className="absolute inset-y-0 right-0 flex items-center justify-center pr-4">
            <FaPhone className="text-[#F06742] dark:text-[#FFA34D] text-lg transition-all duration-300 group-focus-within:scale-110" />
          </div>
          <input
            type="tel"
            name="phoneNumber"
        ...
        <div className="relative group">
          <div className="absolute inset-y-0 right-0 flex items-center justify-center pr-4">
            <FaLock className="text-[#F06742] dark:text-[#FFA34D] text-lg transition-all duration-300 group-focus-within:scale-110" />
          </div>
          <input
            ...
            className="w-full border border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-800 text-black dark:text-white rounded-xl pr-12 pl-12 py-3.5 outline-none focus:ring-2 focus:ring-[#F06742] dark:focus:ring-[#FFA34D] focus:border-transparent transition-all duration-200 group-hover:border-[#F06742]/50 dark:group-hover:border-[#FFA34D]/50 text-right"
          />
          <div className="absolute inset-y-0 left-0 flex items-center justify-center pl-4">
            <div
              onClick={onToggleRegisterPassword}
              className="text-gray-500 dark:text-gray-400 hover:text-[#F06742] dark:hover:text-[#FFA34D] cursor-pointer transition-all duration-200 hover:scale-110"
            >
              {showRegisterPassword ? (
                <FaEyeSlash size={16} />
              ) : (
      ...
      <div className="bg-gradient-to-r from-[#fff8e7] to-[#ffe5b4] dark:from-gray-800 dark:to-gray-700 p-3 rounded-xl border border-[#FFA34D]/30 dark:border-gray-600 space-y-2 transition-colors duration-300">
        <p className="text-sm font-semibold text-[#F06742] dark:text-[#FFA34D] text-right">
          متطلبات كلمة المرور:
        </p>
