      ...
      {isVisible && (
        ...
        >
          ...
          >
            ...
            <div className="bg-gradient-to-r from-[#F06742] to-[#FFA34D] p-6 text-center">
              <motion.div
                initial={{ scale: 0 }}
                animate={{ scale: 1 }}
            ...
            <div className="p-8 space-y-6 text-center">
              ...
              <motion.div
                ...
                className="h-1 bg-gradient-to-r from-[#F06742] to-[#FFA34D] rounded-full"
              />
            </div>
          </motion.div>
          ...
          <div className="absolute inset-0 -z-10 overflow-hidden">
            <div className="absolute top-1/4 left-1/4 w-64 h-64 bg-gradient-to-r from-[#F06742]/5 to-[#FFA34D]/5 rounded-full blur-3xl"></div>
            <div className="absolute bottom-1/4 right-1/4 w-64 h-64 bg-gradient-to-r from-[#FFA34D]/5 to-[#F06742]/5 rounded-full blur-3xl"></div>
          </div>
        </motion.div>
      )}
    </AnimatePresence>
