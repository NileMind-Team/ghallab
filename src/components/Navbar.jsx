...
const Navbar = ({ darkMode, toggleDarkMode }) => {
  ...
  return (
    <>
      <nav className="bg-white/90 dark:bg-gray-900/90 backdrop-blur-xl shadow-lg py-4 px-4 sm:px-6 flex items-center justify-between sticky top-0 z-50 border-b border-[#F06742]/20 dark:border-gray-700 transition-colors duration-300">
        <motion.div
        ...
        >
          ...
          >
            ...
            <div className="relative">
              ...
              <div className="md:hidden absolute -top-1 -right-1 bg-[#F06742] dark:bg-[#FFA34D] rounded-full p-1 border-2 border-white dark:border-gray-900 shadow-sm">
            ...
            <div className="flex flex-col items-start">
              ...
              <div className="flex items-center gap-2">
                <h1 className="hidden md:block text-xl lg:text-2xl font-bold bg-gradient-to-r from-[#F06742] to-[#FFA34D] bg-clip-text text-transparent dark:from-[#FFA34D] dark:to-[#F06742] transition-all duration-300 group-hover:from-[#FFA34D] group-hover:to-[#F06742] dark:group-hover:from-[#F06742] dark:group-hover:to-[#FFA34D]">
                  Ghallab
                </h1>

                {/* Home Icon for Medium+ Screens */}
                <FaHome className="hidden md:block text-[#F06742] dark:text-[#FFA34D] text-sm transition-all duration-300 group-hover:text-[#FFA34D] dark:group-hover:text-[#F06742]" />
              </div>

              {/* Home Indicator Text - All Screens */}
              <div className="flex items-center gap-1">
                <p className="text-xs text-gray-600 dark:text-gray-400 mt-1 flex items-center gap-1 transition-all duration-300 group-hover:text-[#F06742] dark:group-hover:text-[#FFA34D]">
            ...
            <div className="hidden md:block absolute inset-0 -m-2 rounded-2xl bg-gradient-to-r from-[#F06742] to-[#FFA34D] pointer-events-none opacity-0 group-hover:opacity-10 transition-opacity duration-300" />
          </Link>
        </motion.div>
        ...
        <div className="flex items-center gap-4 sm:gap-6 md:gap-8">
          <motion.button
            ...
            className="p-2.5 bg-gradient-to-r from-[#fff8e7] to-[#ffe5b4] dark:from-gray-800 dark:to-gray-700 rounded-xl border border-[#FFA34D]/30 dark:border-gray-600 hover:shadow-lg transition-all duration-300 flex items-center justify-center"
            aria-label={
              darkMode
          ...
          {isLoggedIn ? (
            ...
            >
              <div className="flex items-center gap-2 bg-gradient-to-r from-[#fff8e7] to-[#ffe5b4] dark:from-gray-800 dark:to-gray-700 px-3 py-2 sm:px-4 sm:py-2 rounded-xl border border-[#FFA34D]/30 dark:border-gray-600 hover:shadow-lg transition-all duration-300">
                {userData.avatar ? (
                  <img
                    src={userData.avatar}
                    alt="صورة المستخدم"
                    className="w-8 h-8 rounded-full object-cover border border-[#FFA34D]/50 dark:border-gray-500"
                  />
                ) : (
                  <div className="w-8 h-8 rounded-full bg-[#F06742] text-white flex items-center justify-center font-semibold border border-[#FFA34D]/50 dark:border-gray-500">
            ...
            <div className="relative" ref={dropdownRef}>
              ...
              >
                <div className="flex items-center gap-2 bg-gradient-to-r from-[#F06742] to-[#FFA34D] px-4 sm:px-6 py-2.5 rounded-xl text-white font-semibold shadow-lg hover:shadow-xl hover:shadow-[#F06742]/25 transition-all duration-300">
                  <span>ابدأ الآن</span>
                  <motion.div
              ...
              <AnimatePresence>
                {isDropdownOpen && (
                  <motion.div
                    ...
                    transition={{ duration: 0.2 }}
                    className="absolute top-full right-0 mt-2 w-64 sm:w-72 bg-white/95 dark:bg-gray-800/95 backdrop-blur-xl shadow-2xl rounded-2xl border border-[#F06742]/20 dark:border-gray-600 overflow-hidden z-50"
                  >
                    <div className="p-2">
                          ...
                          <button
                            ...
                            className={`w-full text-right flex items-center justify-between gap-3 px-4 py-3 text-gray-700 dark:text-gray-300 hover:bg-gradient-to-r hover:from-[#fff8e7] hover:to-[#ffe5b4] dark:hover:from-gray-700 dark:hover:to-gray-600 transition-all duration-200 font-medium rounded-lg ${
                              location.pathname === link.path
                                ? "bg-gradient-to-r from-[#fff8e7] to-[#ffe5b4] dark:from-gray-700 dark:to-gray-600 text-[#F06742] dark:text-[#FFA34D]"
                                : ""
                            }`}
                            dir="rtl"
                          >
        ...
        {isLoggedIn && isSidebarOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed top-0 right-0 h-full w-full max-w-xs bg-white/95 dark:bg-gray-900/95 backdrop-blur-xl shadow-2xl border-l border-[#F06742]/20 dark:border-gray-700 z-[70] overflow-y-auto transition-colors duration-300"
            >
              <div className="relative p-6 border-b border-gray-100 dark:border-gray-700 bg-gradient-to-r from-[#fff8e7] to-[#ffe5b4] dark:from-gray-800 dark:to-gray-700">
                ...
                >
                  <FaTimes className="text-[#F06742] dark:text-[#FFA34D] text-lg" />
                </motion.button>
                  ...
                  <div className="flex items-center gap-3">
                    {userData.avatar ? (
                      <img
                        src={userData.avatar}
                        alt="صورة المستخدم"
                        className="w-12 h-12 rounded-full object-cover border-2 border-[#FFA34D] dark:border-[#F06742]"
                      />
                    ) : (
                      <div className="w-12 h-12 rounded-full bg-[#F06742] text-white flex items-center justify-center font-semibold text-lg border-2 border-[#FFA34D] dark:border-[#F06742]">
                        {getInitial(userData.firstName)}
                      </div>
                    )}
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex flex-wrap gap-1 mt-1">
                        {hasRole("Admin") && (
                          <div
                            className="flex flex-row items-center gap-1 bg-[#F06742]/10 dark:bg-[#FFA34D]/20 px-2 py-1 rounded-full"
                            dir="rtl"
                          >
                            <FaUserShield className="text-[#F06742] dark:text-[#FFA34D] text-xs" />
                            <span className="text-xs text-[#F06742] dark:text-[#FFA34D] font-semibold truncate">
                              مدير
                            </span>
                          </div>
                        )}
              ...
              <div className="p-4">
                <div className="space-y-1">
                  ...
                  >
                    ...
                    >
                      <div className="flex-shrink-0 p-2 bg-[#F06742]/10 dark:bg-[#FFA34D]/20 rounded-lg">
                        <FaUser className="text-[#F06742] dark:text-[#FFA34D] text-lg" />
                      </div>
                  ...
                  >
                    ...
                    >
                      <div className="flex-shrink-0 p-2 bg-[#F06742]/10 dark:bg-[#FFA34D]/20 rounded-lg">
                        <FaClipboardList className="text-[#F06742] dark:text-[#FFA34D] text-lg" />
                      </div>
                  ...
                  >
                    ...
                    >
                      <div className="flex-shrink-0 p-2 bg-[#F06742]/10 dark:bg-[#FFA34D]/20 rounded-lg">
                        <FaShoppingCart className="text-[#F06742] dark:text-[#FFA34D] text-lg" />
                      </div>
                  ...
                  >
                    ...
                    >
                      <div className="flex-shrink-0 p-2 bg-[#F06742]/10 dark:bg-[#FFA34D]/20 rounded-lg">
                        <FaHeart className="text-[#F06742] dark:text-[#FFA34D] text-lg" />
                      </div>
                  ...
                  >
                    ...
                    >
                      <div className="flex-shrink-0 p-2 bg-[#F06742]/10 dark:bg-[#FFA34D]/20 rounded-lg">
                        <FaMapMarkerAlt className="text-[#F06742] dark:text-[#FFA34D] text-lg" />
                      </div>
                  ...
                  >
                    ...
                    >
                      <div className="flex-shrink-0 p-2 bg-[#F06742]/10 dark:bg-[#FFA34D]/20 rounded-lg">
                        <FaStar className="text-[#F06742] dark:text-[#FFA34D] text-lg" />
                      </div>
                  ...
                  >
                    ...
                    >
                      <div className="flex-shrink-0 p-2 bg-[#F06742]/10 dark:bg-[#FFA34D]/20 rounded-lg">
                        <FaMap className="text-[#F06742] dark:text-[#FFA34D] text-lg" />
                      </div>
                  ...
                  <div className="border-t border-gray-200 dark:border-gray-700 my-4 pt-4">
                    ...
                    >
                      <button
                        ...
                        className="w-full text-right flex items-center gap-4 px-2 py-2 text-gray-700 dark:text-gray-300 hover:bg-red-50 dark:hover:bg-red-900/20 hover:text-[#F06742] dark:hover:text-[#FFA34D] transition-all duration-200 font-medium rounded-xl border border-transparent hover:border-[#F06742]/30 dark:hover:border-[#FFA34D]/30"
                        dir="rtl"
                      >
                        <div className="flex-shrink-0 p-2 bg-[#F06742]/10 dark:bg-[#FFA34D]/20 rounded-lg">
                          <FaSignOutAlt className="text-[#F06742] dark:text-[#FFA34D] text-lg" />
                        </div>
